	...
	return (
		<div>
			<form onSubmit={handleSubmit} className="p-6 border-t border-gray-100">
				...
				<div className="mb-4">
					<label htmlFor="note" className="block text-sm font-medium text-gray-700 mb-1 text-left">
						Note (optional)
					</label>
					<textarea
						id="note"
						placeholder="Additional info about the transaction..."
						value={note}
						onChange={(e) => setNote(e.target.value)}
						rows={3}
						className="w-full px-4 py-2 rounded-lg border border-gray-300 bg-white text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
					></textarea>
				</div>
